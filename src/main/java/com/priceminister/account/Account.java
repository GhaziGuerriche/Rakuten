...
public interface Account {
     ...
     */
    public void add(Double addedAmount)throws IllegalAddException;
     ...
     */
    public Double withdrawAndReportBalance(Double withdrawnAmount, AccountRule rule) throws IllegalBalanceException,IllegalWithdrawException;
